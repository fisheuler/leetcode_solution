 ...
 */
class Solution {
    private Map<Integer,Integer> levelNumMap = new HashMap<>();
    public int widthOfBinaryTree(TreeNode root) {
        dfsTree(root,0);

        return Collections.max(levelNumMap.values());
    }
    ...
    public void dfsTree(TreeNode root, int level){
        ...
        int num = levelNumMap.getorDefault(level,0)+1;
        levelNumMap.put(level,num);
