package solution;//Implement the BSTIterator class that represents an iterator over the in-order
...
class BSTIterator {
    ...
    public int next() {
        ...
        if(top.right!=null){
            ...
            addLeftChildren(top.right.left);
        }
        return top.val;
    }
    ...
    public static void main(String[] args){
        BSTIterator iterator = new BSTIterator(makeTest());
    ...
    public static TreeNode makeTest(){
