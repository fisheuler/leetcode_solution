package solution;//Design an iterator that supports the peek operation on an existing iterator in
// addition to the hasNext and the next operations. 
//
// Implement the PeekingIterator class: 
//
// 
// PeekingIterator(Iterator<int> nums) Initializes the object with the given int
//eger iterator iterator. 
...
// 
//
// Note: Each language may have a different implementation of the constructor an
//d Iterator, but they all support the int next() and boolean hasNext() functions.
// 
//
// 
// Example 1: 
...
//pes, not just integer? Related Topics Array Design Iterator 
// 👍 1093 👎 737
