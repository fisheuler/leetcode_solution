package solution;//Design a class to find the kth largest element in a stream. Note that it is th
...
class KthLargest {
    ...
    public static void main(String[] args){
        ...
        KthLargest solution = new KthLargest(3,stream);
        for(int add: addStream){
            System.out.println(solution.add(add));
        }
